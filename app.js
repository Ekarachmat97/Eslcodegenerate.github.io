document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .getElementById("expired-code-form")
...
function updateShelfLife() {
  ...
  const shelfLifeChocolate = parseInt(
    document.getElementById("shelflife-Chocolate").value
  );
  ...
  let expiredCodes = generateExpiredCode(
    productionDate,
    productVariant,
    shelfLifeB2B,
    shelfLifeMT,
